! function(i) {
    ...
    ! function(t) {
        ...
        C.Buffer = h, C.SlowBuffer = function(t) {
            +t != t && (t = 0);
            return h.alloc(+t)
        }, C.INSPECT_MAX_BYTES = 50, h.TYPED_ARRAY_SUPPORT = void 0 !== t.TYPED_ARRAY_SUPPORT ? t.TYPED_ARRAY_SUPPORT : function() {
            try {
        ...
        }(), C.kMaxLength = i(), h.poolSize = 8192, h.h = function(t) {
    ...
    ! function(s) {
        ...
        t.prototype.update = function(t, n) {
            ...
            for (var i = this.A += t.length, e = this.O || 0, r = 0, o = this.g; e < i;) {
                for (var u = Math.min(t.length, r + this.S - e % this.S) - r, a = 0; a < u; a++) o[e % this.S + a] = t[a + r];
    ...
    ! function(n) {
        ...
        t(r, i), r.prototype.init = function() {
            return this.K = 1779033703, this.k = 3144134277, this.C = 1013904242, this.N = 2773480762, this.M = 1359893119, this.U = 2600822924, this.D = 528734635, this.P = 1541459225, this
        }, r.prototype.R = function(t) {
            for (var n, i = this.T, e = 0 | this.K, r = 0 | this.k, o = 0 | this.C, u = 0 | this.N, a = 0 | this.M, s = 0 | this.U, f = 0 | this.D, c = 0 | this.P, h = 0; h < 16; ++h) i[h] = t.readInt32BE(4 * h);
            ...
            for (var l = 0; l < 64; ++l) var d = c + ((a >>> 6 | a << 26) ^ (a >>> 11 | a << 21) ^ (a >>> 25 | a << 7)) + (f ^ a & (s ^ f)) + v[l] + i[l] | 0,
                ...
                r = e,
                e = d + w | 0;
            this.K = e + this.K | 0, this.k = r + this.k | 0, this.C = o + this.C | 0, this.N = u + this.N | 0, this.M = a + this.M | 0, this.U = s + this.U | 0, this.D = f + this.D | 0, this.P = c + this.P | 0
        }, r.prototype.j = function() {
            var t = new n(32);
            return t.writeInt32BE(this.K, 0), t.writeInt32BE(this.k, 4), t.writeInt32BE(this.C, 8), t.writeInt32BE(this.N, 12), t.writeInt32BE(this.M, 16), t.writeInt32BE(this.U, 20), t.writeInt32BE(this.D, 24), t.writeInt32BE(this.P, 28), t
        }, o.exports = r
        ...
        t(r, i), r.prototype.init = function() {
            ...
            for (var T = 0; T < 160; T += 2) {
                ...
                var D = $(i, e, r),
                    ...
                    M = z(w, v, y),
                    C = m + C | 0,
                    N = (k = (((f + k + J(C, m) | 0) + N + J(C = C + M | 0, M) | 0) + B[T] + J(C = C + x | 0, x) | 0) + I + J(C = C + j | 0, j) | 0, K + P | 0),
                    M = L + D + J(N, K) | 0,
                    f = s,
                    m = y,
                    s = a,
    ...
    var l = {},
        f = (l.et = t(3), window.pintrk && (window.pintrk.mh = "bd3e0b05", l.et.setVersion(window.pintrk.mh)), l.rt = t(4), t(9)),
        d = t(19),
    ...
    function Ct(t) {
        var n, i;
        window.pintrk.cookieLoaded || (window.pintrk.cookieLoaded = !0, n = d.getCookies(), I() ? (i = f.getParameterFromURI("epik") || d.readCookie(p.EPIK, n), j(n, p.EPIK, i, b.EPIK, "epik"), i && (d.dropCookie(p.EPIK, i), Pt(b.EPIK, i)), j(n, p.UNAUTH, null, b.UNAUTH, ut), i = Object.assign({}, t), window.pintrk.partnerData && (i.pd = window.pintrk.partnerData), k(i, [C, l.ht], l.st.PAGE_LOAD), j(n, p.DERIVED_EPIK, null, b.DERIVED_EPIK, et), t = window.location.pathname, (mt.test(t) || window.pintrk.partnerData && "shopify" === window.pintrk.partnerData.np) && j(n, "_shopify_y", null, null, Q)) : Dt())
    }
    ...
    function Nt(t, n, i) {
        ...
        !x() || e < new Date || t && n && l.ut.setItem(t, JSON.stringify({
            value: n,
            expires: e
        }))
    }
    ...
    function Jt(t) {
        t = f.toBooleanType(t);
        (l.wt.ctEpikIframeEnabled = t) ? (window.addEventListener("message", l.gt), "complete" === document.readyState ? Vt() : window.addEventListener("load", Vt)) : (M(r), M(ot))
    }
                ...
                try {
                    for (u.s(); !(r = u.n()).done;) {
                        ...
                        try {
                            for (f.s(); !(a = f.n()).done;) {
                                var c = a.value;
                                "input" === t ? Ft(o.name, c.fieldRegex) && U(o.value, c, s.tagConfigKey) : "select" === t && c.selectScrapingEnabled && Ft(o.name, c.fieldRegex) && U(o.value, c, s.tagConfigKey)
                            }
                        } catch (t) {
                            f.e(t)
                        } finally {
    ...
    l.wt = {
        ...
        var n, t = c(t, 2),
            i = t[0],
            t = t[1],
            i = ((i = kt(i)) && (window.pintrk.tagId && console.error(v + "'load' command was called multiple times.  Previously for tag id '%s', now for tag id '%s'.", window.pintrk.tagId, i), window.pintrk.tagId = i), Gt(t), !K() && I() && xt() && ! function(t) {
        ...
        t = c(t, 1)[0];
        l.ct = f.toBooleanType(t), !1 === l.ct && Dt()
    }, l.set = function(t) {
        Gt(c(t, 1)[0])
    }, l.page = function(t) {
        var t = c(t, 1)[0],
        ...
        i ? (n.tid = i, t && ("object" === s(t) ? ($t(t), n.ov = t) : console.warn($ + "Unexpected value passed to page command. Please consult the Pinterest Tag Guide for correct notation.")), Ct(n), window.pintrk.partnerData && (n.pd = window.pintrk.partnerData), n[m] = "init", l.At(n)) : console.error(v + "'page' command was called without first calling the 'load' command.  Forthcoming Pinterest tag events may fail.")
    }, l.track = function(t) {
        var n, t = c(t, 5),
            i = t[0],
            e = t[1],
        ...
        return i && "string" == typeof i ? (i = i.trim(), -1 === nt.indexOf(i.toLowerCase()) && console.warn($ + "'%s' is not a standard event name. You may use it to build audiences, but conversion reporting will not be available. Standard event names are: [%s]", i, nt.toString()), u[m] = i) : R("eventName", i, "string"), e && "object" === s(e) ? (void 0 === e.value || isNaN(e.value) || (e.value = Number(e.value)), R("value", e.value, "number"), i = "order_quantity", null == (n = e.order_quantity) || Number(n) == n && n % 1 == 0 || console.error(v + "Expected '%s' to be an integer, but found '%s'", i, n), void 0 !== e.external_id && (N({
            ...
            return n
        }(e), u.ed = i) : R("eventData", e, "object"), "function" != typeof r && (R("callback", r, "function"), r = null), (o = (o = kt(o)) || window.pintrk.tagId) ? (u.tid = String(o).trim(), t && "object" === s(t) && ($t(t), u.ov = t), Ct(u), n = window.location.pathname, mt.test(n) || window.pintrk.partnerData && "shopify" === window.pintrk.partnerData.np && yt.test(n) ? k(u, [C, l.Ot(u, r)], l.st.EVENT_SHOPIFY_SCRAPE) : l.wt.tagConfigsReceived ? (Zt(), window.pintrk.partnerData && (u.pd = window.pintrk.partnerData), !l.rt.isInRampPercentage(l.rt.LIST.DERIVED_EPIK.chance) || d.readCookie(p.DERIVED_EPIK) || Lt(b.DERIVED_EPIK) || k(u, [C], l.st.TAGS_RECEIVED, !0), l.At(u, r)) : k(u, [C, l.Rt(u, r)], l.st.EVENT_TAGS_ABSENT)) : (console.error(v + "'load' command was not called before 'track'.  Did you install the base code?"), r && r(!1, "The Pinterest Tag ID is missing.")), 0
    }, l.Rt = function(t, n) {
        return function() {
            try {
                return Yt(tagConfig = JSON.parse(this.responseText)), Zt(), window.pintrk.partnerData && (t.pd = window.pintrk.partnerData), l.At(t, n), 0
            } catch (t) {
        ...
        return function() {
            try {
                ...
                return i && i[0] && (i = i[0].textContent) && "string" == typeof i && lt.test(i.trim().toLowerCase()) && D(n, i, _, O, e), (i = document.getElementsByTagName("address")) && i[0] && (i = i[0].innerHTML) && "string" == typeof i && (i = i.split("<br>")) && (i[0] && dt.test(i[0].trim().toLowerCase()) && ((t = i[0].split(" ")) && 1 === t.length ? D(n, t[0], S, _t, e) : t && 2 === t.length && (D(n, t[0], S, Et, e), D(n, t[1], S, _t, e))), 3 <= i.length && i[2] && (t = i[2].split(" ")) && (t[0] && E.test(t[0].trim().toLowerCase()) && D(n, t[0], A, At, e), t[1] && E.test(t[1].trim().toLowerCase()) && D(n, t[1], A, Ot, e), t[2]) && vt.test(t[2].trim().toLowerCase()) && D(n, t[2], A, Rt, e), 4 <= i.length && i[3] && E.test(i[3].trim().toLowerCase()) && D(n, i[3], A, jt, e), 5 <= i.length) && i[4] && wt.test(i[4].trim().toLowerCase()) && D(n, i[4], pt, St, e), N({
                    aem_eligible_list: e
                }), window.pintrk.partnerData && (r.pd = window.pintrk.partnerData), l.At(r, o), 0
            } catch (t) {
        ...
        var f;
        if (l.ct) return f = l.jt(), l.St().catch(function(t) {
            ...
            if ((K() ? T : Mt)(), l.rt.isInRampPercentage(l.rt.LIST.FETCH_API_V3.chance)) {
        ...
        var t = null,
            ...
            n = (window.pintrk.mh && (t.mh = window.pintrk.mh, l.rt.isInRampPercentage(l.rt.LIST.CHECK_REDIRECTED.chance)) && (n = document.currentScript) && (n = f.getHashFromURI(n.src)) && n !== window.pintrk.mh && (t.cs = n), l.lt(w)),
        ...
        return null != n && (t[u] = n), x() && (t.epikDataSource = l.wt.epikDataSource, t.derivedEpikDataSource = l.wt.derivedEpikDataSource, t.unauthIdDataSource = l.wt.unauthIdDataSource), t
    }, l.Kt = function(t, n) {
        function i() {
    ...
    ! function(n) {
        ...
        t(r, i), r.prototype.init = function() {
            return this.K = 1732584193, this.k = 4023233417, this.C = 2562383102, this.N = 271733878, this.M = 3285377520, this
        }, r.prototype.R = function(t) {
            for (var n = this.T, i = 0 | this.K, e = 0 | this.k, r = 0 | this.C, o = 0 | this.N, u = 0 | this.M, a = 0; a < 16; ++a) n[a] = t.readInt32BE(4 * a);
            ...
            for (var s, f, c, h = 0; h < 80; ++h) var l = ~~(h / 20),
                ...
                e = i,
                i = d;
            this.K = i + this.K | 0, this.k = e + this.k | 0, this.C = r + this.C | 0, this.N = o + this.N | 0, this.M = u + this.M | 0
        }, r.prototype.j = function() {
            var t = new n(20);
            return t.writeInt32BE(0 | this.K, 0), t.writeInt32BE(0 | this.k, 4), t.writeInt32BE(0 | this.C, 8), t.writeInt32BE(0 | this.N, 12), t.writeInt32BE(0 | this.M, 16), t
        }, o.exports = r
    }.call(this, u(0).Buffer)
}, function(t, n) {
    var i = function() {
    ...
    ! function(n) {
        ...
        t(r, i), r.prototype.init = function() {
            ...
            for (var n, i = this.T, e = 0 | this.K, r = 0 | this.k, o = 0 | this.C, u = 0 | this.N, a = 0 | this.M, s = 0; s < 16; ++s) i[s] = t.readInt32BE(4 * s);
            ...
            for (var f, c, h, l = 0; l < 80; ++l) var d = ~~(l / 20),
                ...
                r = e,
                e = w;
            this.K = e + this.K | 0, this.k = r + this.k | 0, this.C = o + this.C | 0, this.N = u + this.N | 0, this.M = a + this.M | 0
        }, r.prototype.j = function() {
            var t = new n(20);
            return t.writeInt32BE(0 | this.K, 0), t.writeInt32BE(0 | this.k, 4), t.writeInt32BE(0 | this.C, 8), t.writeInt32BE(0 | this.N, 12), t.writeInt32BE(0 | this.M, 16), t
        }, o.exports = r
    ...
    ! function(n) {
        ...
        t(o, i), o.prototype.init = function() {
            return this.K = 3238371032, this.k = 914150663, this.C = 812702999, this.N = 4144912697, this.M = 4290775857, this.U = 1750603025, this.D = 1694076839, this.P = 3204075428, this
        }, o.prototype.j = function() {
            var t = new n(28);
            return t.writeInt32BE(this.K, 0), t.writeInt32BE(this.k, 4), t.writeInt32BE(this.C, 8), t.writeInt32BE(this.N, 12), t.writeInt32BE(this.M, 16), t.writeInt32BE(this.U, 20), t.writeInt32BE(this.D, 24), t
        }, u.exports = o
